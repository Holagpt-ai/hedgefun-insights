-- Re-apply of 20260922250000_intraday_reconstruction_v1.sql (0021 was recorded but skipped: its journal timestamp is older than 0019). Contents unedited; NOTIFY added to reload the PostgREST schema cache.
