-- Scanner Phase 2 RPC fix: persist primary_scanner_event* and scanner_events on candidates.
-- Columns already applied via 20260923180000_radar_v22_scanner_events.sql (prod).
