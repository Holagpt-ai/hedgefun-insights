...
export function MarketMoversLayout({
  sectionTitle,
  rows,
  isLoading,
  refetch,
  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <h1 className="text-[1.75rem] font-bold mb-4 text-foreground">Market Movers</h1>
        ...
        {/* Section Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3 mt-4">
