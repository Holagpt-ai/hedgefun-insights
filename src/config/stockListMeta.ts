...
export const LIST_METADATA: Record<string, ListMeta> = {
  ...
  // Market Cap Groups
  "mega-cap": { title: "Mega-Cap Stocks", description: "Companies with a market cap above $200 billion.", columns: MARKET_CAP_COLS },
  "large-cap": { title: "Large-Cap Stocks", description: "Companies with a market cap between $10 billion and $200 billion.", columns: MARKET_CAP_COLS },
  "mid-cap": { title: "Mid-Cap Stocks", description: "Companies with a market cap between $2 billion and $10 billion.", columns: MARKET_CAP_COLS },
  "small-cap": { title: "Small-Cap Stocks", description: "Companies with a market cap between $300 million and $2 billion.", columns: MARKET_CAP_COLS },
  "micro-cap": { title: "Micro-Cap Stocks", description: "Companies with a market cap between $50 million and $300 million.", columns: MARKET_CAP_COLS },
  "nano-cap": { title: "Nano-Cap Stocks", description: "Companies with a market cap below $50 million.", columns: MARKET_CAP_COLS },

  // U.S. Exchanges
  "nyse": { title: "Stocks Listed on NYSE", description: "All stocks listed on the New York Stock Exchange.", columns: EXCHANGE_COLS },
  "nyse-american": { title: "Stocks Listed on NYSE American", description: "All stocks listed on NYSE American (formerly AMEX).", columns: EXCHANGE_COLS },
  "nasdaq": { title: "Stocks Listed on NASDAQ", description: "All stocks listed on the NASDAQ stock exchange.", columns: EXCHANGE_COLS },
  "otc": { title: "Stocks Listed on OTC Markets", description: "Stocks traded on OTC markets outside major exchanges.", columns: EXCHANGE_COLS },
  ...
  "dow-jones": { title: "Dow Jones Companies", description: "The 30 companies that make up the Dow Jones Industrial Average.", columns: MARKET_CAP_COLS },

  // Other Lists
  "faang": { title: "FAANG Stocks", description: "Meta, Apple, Amazon, Netflix, and Alphabet — the original FAANG tech giants.", columns: ["symbol", "name", "price", "changePercent", "marketCap", "peRatio", "revenue"] },
  ...
  "bdc": { title: "Business Development Companies", description: "Publicly traded BDCs that provide financing to small and mid-sized businesses.", columns: ["symbol", "name", "divYield", "price", "changePercent", "marketCap"] },
  ...
  "penny-stocks": { title: "Penny Stocks (Under $5)", description: "Stocks trading below $5 per share listed on major U.S. exchanges.", columns: ["symbol", "name", "price", "changePercent", "volume", "marketCap"] },
  "reits": { title: "All REITs", description: "Real estate investment trusts listed on U.S. stock exchanges.", columns: ["symbol", "name", "divYield", "price", "changePercent", "marketCap"] },
  ...
  "magnificent-seven": { title: "The Magnificent Seven", description: "Apple, Microsoft, Nvidia, Alphabet, Amazon, Meta, and Tesla.", columns: ["symbol", "name", "price", "changePercent", "marketCap", "peRatio", "revenue"] },
  ...
  "ai": themeList("Artificial Intelligence Stocks"),
  "ev": themeList("Electric Vehicle Stocks"),
  "banks": themeList("Bank Stocks"),
  "pharma": themeList("Pharmaceutical Stocks"),
  "clean-energy": themeList("Clean Energy Stocks"),
  "robotics": themeList("Robotics Stocks"),
  "gaming": themeList("Gaming Stocks"),
  "social-media": themeList("Social Media Stocks"),
  "mobile-games": themeList("Mobile Gaming Stocks"),
  "esports": themeList("E-Sports Stocks"),
  "rare-earth": themeList("Rare Earth Stocks"),
  "car-companies": themeList("Car Company Stocks"),
  "online-dating": themeList("Online Dating Stocks"),
  "vr": themeList("Virtual Reality Stocks"),
  "ar": themeList("Augmented Reality Stocks"),
  "metaverse": themeList("Metaverse Stocks"),
  "glp1": themeList("Weight Loss / GLP-1 Stocks"),
  "sports-betting": themeList("Sports Betting Stocks"),
  "online-gambling": themeList("Online Gambling Stocks"),
