...
const translations: Translations = {
  ...
  upcomingIpos: { en: "Upcoming IPOs", es: "Próximas OPVs" },
  spacList: { en: "SPAC List", es: "Lista SPAC" },
  etfScreener: { en: "ETF Screener", es: "Filtro ETF" },
  topEtfs: { en: "Top ETFs", es: "Mejores ETFs" },
  etfCompare: { en: "ETF Compare", es: "Comparar ETFs" },
