...
export const RADAR_COLUMN_DEFINITIONS: readonly RadarColumnDefinition[] = [
  ...
  { id: "price_move", label: "Last / Move", fieldId: "move", defaultVisible: true, required: false, align: "right", optional: false },
  { id: "volume", label: "TODAY VOL", fieldId: "volume", defaultVisible: true, required: false, align: "right", optional: false },
  { id: "prior_volume", label: "YDAY VOL", fieldId: "prior_volume", defaultVisible: true, required: false, align: "right", optional: false },
  { id: "volume_ratio", label: "VOL/YDAY", fieldId: "volume_ratio", defaultVisible: true, required: false, align: "right", optional: false },
