...
export function rankRadarRows(
  ...
  return rows.map((row, index) => {
    ...
    return {
      ...
      primary_scanner_event: ranking.primary_scanner_event,
      primary_scanner_event_at: ranking.primary_scanner_event_at,
      scanner_events: ranking.scanner_events,
      promotion_reason: ranking.promotion_reason ?? null,
      radar_event_lifecycle: ranking.radar_event_lifecycle ?? null,
      participation_state: ranking.participation_state ?? null,
      time_adjusted_rvol: ranking.time_adjusted_rvol ?? null,
      volume_5m: ranking.volume_5m ?? null,
      distance_from_hod_pct: ranking.distance_from_hod_pct,
