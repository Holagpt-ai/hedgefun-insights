...
export default function MethodologyPage() {
  useEffect(() => {
    document.title = "Data & Methodology | HedgeFun";
  }, []);
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              HedgeFun aggregates financial data from multiple regulated, institutional-grade sources. Our primary market data provider is Polygon.io, a licensed financial data platform that delivers real-time and historical price quotes, trade-level data, corporate actions, and options chain data directly from U.S. exchanges including NYSE, NASDAQ, CBOE, and OTC Markets.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-3">
              All stock prices, ETF net asset values, index levels, and options Greeks displayed on HedgeFun are sourced from Polygon.io feeds. We do not generate, estimate, or fabricate any raw market data. Every figure you see on HedgeFun originates from a regulated exchange or licensed data provider.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-3">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              Different data types on HedgeFun update at different frequencies depending on source availability and exchange rules:
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              HedgeFun maintains a strict separation between data reporting and editorial opinion. All market data displayed on the platform is sourced directly from third-party providers without editorial modification. Where HedgeFun editorial commentary appears — including AI-generated summaries, sector analyses, and market overviews — it is clearly labeled and distinguished from raw data.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-3">
              We do not accept payment to feature, promote, or favorably present any stock, ETF, or financial product. Our screener rankings, stock lists, and analytical outputs are determined entirely by objective data criteria. HedgeFun has no brokerage relationships and does not earn commissions on securities transactions.
            </p>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              All financial data is subject to delays, errors, and omissions beyond HedgeFun's control. Market data feeds can experience interruptions during periods of extreme volatility, system maintenance, or exchange-level outages. HedgeFun implements a caching layer to minimize data gaps, but users should be aware that displayed data may not always reflect the absolute latest market conditions.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Past performance of any stock, ETF, index, or investment strategy displayed on HedgeFun does not guarantee or predict future results. Investing in securities involves risk, including the possible loss of principal. HedgeFun is an informational platform only — nothing on this site constitutes personalized investment advice. Always consult a licensed financial advisor before making investment decisions.
            </p>
          </section>
        </div>
      </div>
