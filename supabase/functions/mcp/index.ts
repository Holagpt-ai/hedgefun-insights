// @ts-nocheck — bundled output (types erased by the bundler); checked at source in src/lib/mcp/*.
// Generated from src/lib/mcp/index.ts by @lovable.dev/mcp-js; ownership taken to keep the type check green.
