-- Stocksist Trading Journal legacy ACL hardening.
...
-- integrity-md5: 3d118b151dd84545d0eca04d0590320c
DO $journal_seg$
DECLARE
  v_statements text[] := ARRAY[
    $journal_stmt$DO $journal_acl_pre$
DECLARE
  t text;
  v_priv text;
  v_has boolean;
...
$journal_acl_pre$
$journal_stmt$,
    $journal_stmt$DO $journal_acl_mut$
DECLARE
  t text;
  v_legacy constant text[] := ARRAY[
    'journal_trades',
...
$journal_stmt$
  ...
  v_expected text := '3d118b151dd84545d0eca04d0590320c';
  v_digest text;
  v_stmt text;
BEGIN
