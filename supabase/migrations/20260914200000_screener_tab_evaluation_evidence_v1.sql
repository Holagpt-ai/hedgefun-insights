...
COMMENT ON COLUMN public.screener_feed_state.tab_evaluation_evidence IS
  'Compact per-tab evaluation evidence (universe/qualified counts, prerequisite status).';
